...
<body>
    <!-- Navigation -->
    <nav class="navbar fixed-top navbar-expand-lg navbar-light mb-9" style="background-color:#FFFFFF">

            <a class="navbar-brand" href="#">
              <img src="../projetoimg/core-sl.png" width="100px" alt="">
            </a>
              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  ...
                  <!-- 
                           ...
                           por que? mostrar dados 
        
                           unificação do bancos de sangue
                ...
                <li class="nav-item">
                  <a class="nav-link" href="#">
                    Ser voluntario
                    <img src="../projetoimg/doe-final.png" width="30" height="30" class=" align-center" alt="">
                  </a>
                </li>
                <li class="nav-item">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card h-100 ">
                            <a href="#"><img class="card-img-top" src="../projetoimg/camisa-branca.jpg" alt=""></a>
                            <div class="card-body">
                                <h4 class="card-title">
                                    <a href="#"></a>
                                </h4>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card h-100 mb-3">
                            <a href="#"><img class="card-img-top" src="../projetoimg/bone.jpg" alt=""></a>
                            <div class="card-body">
                                <h4 class="card-title">
                                    <a href="#"></a>
                                </h4>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card h-100 mb-3">
                            <a href="#"><img class="card-img-top" src="../projetoimg/pulseira.jpg" alt=""></a>
                            <div class="card-body">
                                <h4 class="card-title">
                                    <a href="#"></a>
                                </h4>
